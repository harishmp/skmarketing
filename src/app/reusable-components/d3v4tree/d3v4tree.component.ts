...
@Component({
  ...
  templateUrl: './d3v4tree.component.html',
  styleUrls: ['./d3v4tree.component.css']
})
export class D3v4treeComponent implements OnInit {
...
var treeData =
{
  ...
  "children": [
    { 
      ...
      "icon": "http://www.bigbiz.com/bigbiz/icons/ultimate/Comic/Comic13.gif",
      "children": [
        { "name": "Kumar N", "icon": "http://www.bigbiz.com/bigbiz/icons/ultimate/Comic/Comic13.gif" },
        { "name": "Ramasawmy L", "icon": "http://www.bigbiz.com/bigbiz/icons/ultimate/Comic/Comic13.gif" }
      ]
    },
    { "name": "Murali G",
    "icon": "http://www.bigbiz.com/bigbiz/icons/ultimate/Comic/Comic13.gif",
        ...
        { 
          ...
          "children": [
            { 
              ...
              "children": [
                { 
                  "name": "Balaji M", "icon": "http://www.bigbiz.com/bigbiz/icons/ultimate/Comic/Comic13.gif", },
                { "name": "Sathis H", "icon": "http://www.bigbiz.com/bigbiz/icons/ultimate/Comic/Comic13.gif", }
              ] 
             },
            { "name": "Sathis H", "icon": "http://www.bigbiz.com/bigbiz/icons/ultimate/Comic/Comic13.gif", }
          ] 
